...
cmd="stdbuf -o L python3 mmd_gan.py --dataset ${DATASET} --dataroot ${DATAROOT} --batch_size ${BS} --image_size ${ISIZE} --nc ${NC}  --nz ${NZ} --max_iter ${MAX_ITER} --gpu_device ${GPU_ID} --experiment ${EXP_FILE} | tee ${LOG_FILE}"
